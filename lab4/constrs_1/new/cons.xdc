...
# LEDs
set_property PACKAGE_PIN U14 [get_ports light[0]]
set_property PACKAGE_PIN U15 [get_ports light[1]]
set_property PACKAGE_PIN W18 [get_ports light[2]]
...
# Buttons
set_property PACKAGE_PIN W19 [get_ports lr[0]]
set_property PACKAGE_PIN U18 [get_ports reset]
set_property PACKAGE_PIN T17 [get_ports lr[1]]
set_property IOSTANDARD LVCMOS33 [get_ports {lr reset}]